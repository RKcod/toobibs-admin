(function () {
  ...
  C.prototype.c = function (a, b) {
    ...
    if (14 == a.c)
      return k(b) && pa.test(b) && ((a = Number(b)), 0 < a) ? a : b;
    if (!a.l) return b;
    a = a.m;
    if (a === String) {
...
*/
  ...
  function R(a) {
    ...
    var b = "" + t(a, 2);
    return null != a.a[4] && t(a, 4) && 0 < y(a, 8)
  ...
  function Y(a, b, c, d) {
    ...
    if (2 == d)
      if (La(V(c, 0)))
        (a = V(c, 1)),
          La(a) &&
            ((f = f.concat(0 == A(a, 9) ? w(t(c, 1), 9) : w(a, 9))),
            q(f),
  ...
  function Sa(a, b, c, d) {
    ...
    try {
      ...
      if ("Invalid country calling code" == L.message && N.test(l)) {
        if (((l = l.replace(N, "")), (h = Qa(a, l, g, b, d, f)), 0 == h))
          throw L;
      } else throw L;
    }
    0 != h
