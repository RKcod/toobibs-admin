...
let DashboardComponent = class DashboardComponent {
    constructor(api, datepipe, spinner) {
        this.api = api;
    ...
    ngOnInit() {
        ...
        this.api.getData().subscribe(response => {
            this.account = response.account.data;
            this.stats = response.statistics.data;
        });
    ...
    getDoctor() {
        this.api.performGetRequest('users?orderBy=first_name&search=user_type:doctor&limit=1000').then(res => {
    ...
    loadSum(calc = false) {
        ...
        this.api.performGETCall('searchappointments', {
            ...
            this.gains.users = res.data.type;
            this.gains.appointments = res.data.address;
    ...
    onDoctorSelectionChange(event) {
        this.api.performGetRequest(`count-sms?doctorId=${event.target.value}`).then(res => {
            this.count_sms = res;
        });
    }
    searchSMS() {
        ...
        let params = 'count-sms';
        if (year && month) {
            params = `count-sms?month=${month}&year=${year}`;
        }
        this.api.performGetRequest(params).then(res => {
            this.user_sms = res;
        });
    }
    calculateTotalSMS() {
        return this.user_sms.reduce((total, sms) => total + sms.appointment_count * 3, 0);
    }
};
...
DashboardComponent = __decorate([
    ...
    __metadata("design:paramtypes", [_api_api_service__WEBPACK_IMPORTED_MODULE_2__["ApiService"], _angular_common__WEBPACK_IMPORTED_MODULE_3__["DatePipe"], ngx_spinner__WEBPACK_IMPORTED_MODULE_4__["NgxSpinnerService"]])
], DashboardComponent);
...
/* harmony import */ var _centers_centers_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../centers/centers.component */ "./src/app/centers/centers.component.ts");
...
/* harmony import */ var _users_user_details_user_details_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../../users/user-details/user-details.component */ "./src/app/users/user-details/user-details.component.ts");
/* harmony import */ var _specialities_specialities_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../../specialities/specialities.component */ "./src/app/specialities/specialities.component.ts");
/* harmony import */ var _cancelled_appointments_cancelled_appointments_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../../cancelled-appointments/cancelled-appointments.component */ "./src/app/cancelled-appointments/cancelled-appointments.component.ts");
/* harmony import */ var _sms_sms_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../../sms/sms.component */ "./src/app/sms/sms.component.ts");
var __importDefault = (undefined && undefined.__importDefault) || function (mod) {
  return (mod && mod.__esModule) ? mod : { "default": mod };
};
...
const AdminLayoutRoutes = [
    ...
    { path: 'centers', component: _centers_centers_component__WEBPACK_IMPORTED_MODULE_9__["CentersComponent"] },
    { path: 'settings', component: _settings_settings_component__WEBPACK_IMPORTED_MODULE_10__["SettingsComponent"] },
    { path: 'user-details', component: _users_user_details_user_details_component__WEBPACK_IMPORTED_MODULE_11__["UserDetailsComponent"] },
    ...
    { path: 'specialities', component: _specialities_specialities_component__WEBPACK_IMPORTED_MODULE_12__["SpecialitiesComponent"] },
    { path: 'rdv-annule', component: _cancelled_appointments_cancelled_appointments_component__WEBPACK_IMPORTED_MODULE_13__["CancelledAppointmentsComponent"] },
    { path: 'sms', component: _sms_sms_component__WEBPACK_IMPORTED_MODULE_14__["SmsComponent"] },
];
